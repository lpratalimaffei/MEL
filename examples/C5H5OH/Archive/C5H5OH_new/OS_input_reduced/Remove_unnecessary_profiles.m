...
fprintf(['The total number of retained profiles is ' num2str(tot_profiles) '\n']);
fprintf(['The removed ones are ' num2str(100-tot_profiles*100/(size(List_of_Exp,1)*7)) ' percent \n' ]);