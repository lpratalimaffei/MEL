...
T  = [300 400 600 800 1000 1200 1400 1600 1800 2000 2200 2400 2500];
P  = [0.1 1 10 100];
SP = {'Pr1', 'Pr2', 'Pr3', 'W1'};
...
for i = 1:size(List_of_Exp,1)
    ...
    elseif strcmp(A{1,3},[num2str(T(10)) 'K'])
            row = 10;
    elseif strcmp(A{1,3},[num2str(T(11)) 'K'])
            row = 11;
    elseif strcmp(A{1,3},[num2str(T(12)) 'K'])
            row = 12;
    elseif strcmp(A{1,3},[num2str(T(13)) 'K'])
            row = 13;
    end
    
    % choose pressure
    if strcmp(A{1,2},[num2str(P(1),'%10.1f') 'atm'])
            line = 1;
...
for i = 1:size(cell,1)
    ...
    lgd = legend({'Pr1', 'Pr2', 'Pr3', 'W1'} , 'FontSize', 12, 'Location' , 'Best');
